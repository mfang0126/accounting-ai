...
> **什么时候读：** 需要查 NZ 会计规则、AI 角色边界、真实使用场景时。日常路由不需要读。
> 回答一个问题：这个 AI 到底是什么、不是什么、怎么用。
...
| GST | 已注册，15% |
| 故意埋入的 5 个问题 | 部分付款、完全未收、工资差异、GST 验证、正确交易不误报 |

> 5 个错误的完整验证标准（含具体金额和 AI 应答）见 `CAPABILITY.md`。
