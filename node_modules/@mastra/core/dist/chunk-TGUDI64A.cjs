...
var CoreToolBuilder = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  constructor(input) {
    ...
    if (!chunkU3HBG2GU_cjs.isVercelTool(this.originalTool) && (input.autoResumeSuspendedTools || this.originalTool.id?.startsWith("agent-"))) {
  ...
  getParameters = () => {
    if (chunkU3HBG2GU_cjs.isVercelTool(this.originalTool)) {
  ...
  createExecute(tool, options, logType, processedSchema) {
    ...
    const execFunction = async (args, execOptions) => {
      ...
      try {
        ...
        if (chunkU3HBG2GU_cjs.isVercelTool(tool)) {
          ...
          if (resumeData) {
            const resumeValidation = chunkU3HBG2GU_cjs.validateToolInput(resumeSchema, resumeData, options.name);
        ...
        if (suspendData) {
          ...
          const suspendValidation = chunkU3HBG2GU_cjs.validateToolSuspendData(suspendSchema, suspendData, options.name);
        ...
        if (chunkU3HBG2GU_cjs.isVercelTool(tool)) {
          ...
          const outputValidation = chunkU3HBG2GU_cjs.validateToolOutput(outputSchema, result, options.name, false);
    ...
    return async (args, execOptions) => {
      ...
      try {
        ...
        const { data, error: error2 } = chunkU3HBG2GU_cjs.validateToolInput(parameters, args, options.name);
        if (error2) {
  ...
  build() {
    ...
    let needsApprovalFn;
    if (chunkU3HBG2GU_cjs.isVercelTool(this.originalTool) && "needsApproval" in this.originalTool) {
...
function ensureToolProperties(tools) {
  const toolsWithProperties = Object.keys(tools).reduce((acc, key) => {
    ...
    if (tool) {
      if (typeof tool === "function" && !(tool instanceof chunkU3HBG2GU_cjs.Tool) && !chunkU3HBG2GU_cjs.isVercelTool(tool)) {
...
//# sourceMappingURL=chunk-TGUDI64A.cjs.map
//# sourceMappingURL=chunk-TGUDI64A.cjs.map