...
import type { AnySpan, TracingContext, TracingOptions, TracingPolicy, TracingProperties } from '../observability/index.js';
 ...
 */
export type StepParams<TStepId extends string, TStateSchema extends z.ZodTypeAny | undefined, TInputSchema extends z.ZodTypeAny, TOutputSchema extends z.ZodTypeAny, TResumeSchema extends z.ZodTypeAny | undefined = undefined, TSuspendSchema extends z.ZodTypeAny | undefined = undefined, TRequestContextSchema extends z.ZodTypeAny | undefined = undefined> = {
    id: TStepId;
    description?: string;
    ...
    metadata?: StepMetadata;
    execute: ExecuteFunction<TStateSchema extends z.ZodTypeAny ? z.infer<TStateSchema> : unknown, z.infer<TInputSchema>, z.infer<TOutputSchema>, TResumeSchema extends z.ZodTypeAny ? z.infer<TResumeSchema> : unknown, TSuspendSchema extends z.ZodTypeAny ? z.infer<TSuspendSchema> : unknown, DefaultEngineType, TRequestContextSchema extends z.ZodTypeAny ? z.infer<TRequestContextSchema> : unknown>;
};
/**
