...
import type { WorkspaceToolsConfig } from './types.js';
/**
 ...
 */
export declare function resolveToolConfig(toolsConfig: WorkspaceToolsConfig | undefined, toolName: WorkspaceToolName): {
    enabled: boolean;
 ...
 */
export declare function createWorkspaceTools(workspace: Workspace): Record<string, any>;
