...
var getTraceStep = chunkHWG7NPJA_cjs.createStep({
...
async function validateAndSaveScore({ storage, scorerResult }) {
  ...
  const payloadToSave = chunk6GSWC5ZA_cjs.saveScorePayloadSchema.parse(scorerResult);
...
var scoreTracesWorkflow = chunkHWG7NPJA_cjs.createWorkflow({
