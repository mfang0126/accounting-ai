...
import type { ProcessInputStepResult, Processor, ProcessorMessageResult, ProcessorStreamWriter, ProcessorWorkflow, RunProcessInputStepArgs, RunProcessInputStepResult, ToolCallInfo } from './index.js';
/**
...
export declare class ProcessorRunner {
    ...
    constructor({ inputProcessors, outputProcessors, logger, agentName, processorStates, }: {
    ...
    runOutputProcessors(messageList: MessageList, tracingContext?: TracingContext, requestContext?: RequestContext, retryCount?: number, writer?: ProcessorStreamWriter): Promise<MessageList>;
    /**
     * Process a stream part through all output processors with state management
     */
    processPart<OUTPUT>(part: ChunkType<OUTPUT>, processorStates: Map<string, ProcessorState<OUTPUT>>, tracingContext?: TracingContext, requestContext?: RequestContext, messageList?: MessageList, retryCount?: number, writer?: ProcessorStreamWriter): Promise<{
    ...
    runOutputProcessorsForStream<OUTPUT = undefined>(streamResult: MastraModelOutput<OUTPUT>, tracingContext?: TracingContext, writer?: ProcessorStreamWriter): Promise<ReadableStream<any>>;
