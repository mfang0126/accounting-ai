...
export declare const traceIdField: z.ZodString;
/** Zod schema for span ID field */
export declare const spanIdField: z.ZodString;
...
export declare const spanRecordSchema: z.ZodObject<{
    ...
    links: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodUnknown, "many">>>;
    ...
    entityType: z.ZodOptional<z.ZodNullable<z.ZodNativeEnum<typeof import("../../../observability").EntityType>>>;
    ...
    name: z.ZodString;
    spanType: z.ZodNativeEnum<typeof SpanType>;
    ...
    output?: unknown;
    entityType?: import("../../../observability").EntityType | null | undefined;
 ...
 */
export declare function computeTraceStatus(span: SpanRecord): TraceStatus;
...
export declare const traceSpanSchema: z.ZodObject<{
    ...
    status: z.ZodNativeEnum<typeof TraceStatus>;
}, "strip", z.ZodTypeAny, {
    status: TraceStatus;
    createdAt: Date;
    name: string;
 ...
 */
export declare const createSpanRecordSchema: z.ZodObject<Omit<{
    createdAt: z.ZodDate;
    updatedAt: z.ZodNullable<z.ZodDate>;
    attributes: z.ZodOptional<z.ZodNullable<z.ZodRecord<z.ZodString, z.ZodUnknown>>>;
    links: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodUnknown, "many">>>;
...
export declare const tracesFilterSchema: z.ZodObject<{
    status: z.ZodOptional<z.ZodNativeEnum<typeof TraceStatus>>;
    hasChildError: z.ZodOptional<z.ZodEffects<z.ZodBoolean, boolean, unknown>>;
    entityType: z.ZodOptional<z.ZodNullable<z.ZodNativeEnum<typeof import("../../../observability").EntityType>>>;
    entityId: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    entityName: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    userId: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    ...
    spanType: z.ZodOptional<z.ZodNativeEnum<typeof SpanType>>;
}, "strip", z.ZodTypeAny, {
    runId?: string | null | undefined;
    threadId?: string | null | undefined;
    resourceId?: string | null | undefined;
    ...
    serviceName?: string | null | undefined;
    tags?: string[] | null | undefined;
    hasChildError?: unknown;
}>;
/**
 * Fields available for ordering trace results
 */
export declare const tracesOrderByFieldSchema: z.ZodEnum<["startedAt", "endedAt"]>;
/**
...
export declare const tracesOrderBySchema: z.ZodObject<{
    field: z.ZodDefault<z.ZodEnum<["startedAt", "endedAt"]>>;
    direction: z.ZodDefault<z.ZodEnum<["ASC", "DESC"]>>;
}, "strip", z.ZodTypeAny, {
    field: "endedAt" | "startedAt";
    direction: "ASC" | "DESC";
}, {
    field?: "endedAt" | "startedAt" | undefined;
 ...
 */
export declare const updateSpanRecordSchema: z.ZodObject<Omit<Omit<{
    createdAt: z.ZodDate;
    updatedAt: z.ZodNullable<z.ZodDate>;
    attributes: z.ZodOptional<z.ZodNullable<z.ZodRecord<z.ZodString, z.ZodUnknown>>>;
    links: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodUnknown, "many">>>;
    ...
    traceId: z.ZodString;
    spanId: z.ZodString;
}, "createdAt" | "updatedAt">, "traceId" | "spanId">, "strip", z.ZodTypeAny, {
    name: string;
    startedAt: Date;
    spanType: SpanType;
    isEvent: boolean;
...
export declare const updateSpanArgsSchema: z.ZodObject<{
    ...
    updates: z.ZodObject<{
        ...
        entityType: z.ZodOptional<z.ZodOptional<z.ZodNullable<z.ZodNativeEnum<typeof import("../../../observability").EntityType>>>>;
        entityId: z.ZodOptional<z.ZodOptional<z.ZodNullable<z.ZodString>>>;
        links: z.ZodOptional<z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodUnknown, "many">>>>;
...
export declare const listScoresBySpanResponseSchema: z.ZodObject<{
    ...
    scores: z.ZodArray<z.ZodObject<{
        ...
        entityType: z.ZodOptional<z.ZodEnum<[string, string, ...string[]]>>;
