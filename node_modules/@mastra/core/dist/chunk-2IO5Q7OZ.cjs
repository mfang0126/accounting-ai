  ...
  async handlePrepareStep(args, currentResult) {
    if (this.settings.prepareStep) {
      ...
      if (currentResult.model) {
        const resolvedModel = await chunkN3ROEJG4_cjs.resolveModelConfig(currentResult.model);
        if (!chunkVTVCMIAI_cjs.isSupportedLanguageModel(resolvedModel)) {
...
function toolLoopAgentToMastraAgent(agent, options) {
  ...
  return new chunkVTVCMIAI_cjs.Agent({
    ...agentConfig,
    id,
...
//# sourceMappingURL=chunk-2IO5Q7OZ.cjs.map
//# sourceMappingURL=chunk-2IO5Q7OZ.cjs.map