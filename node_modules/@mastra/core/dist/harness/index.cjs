...
var planCounter = 0;
var askUserTool = chunkU3HBG2GU_cjs.createTool({
  id: "ask_user",
...
var submitPlanTool = chunkU3HBG2GU_cjs.createTool({
  id: "submit_plan",
...
var taskWriteTool = chunkU3HBG2GU_cjs.createTool({
  id: "task_write",
...
var taskCheckTool = chunkU3HBG2GU_cjs.createTool({
  id: "task_check",
...
- The task is self-contained and can be delegated`,
    ...
    execute: async ({ agentType, task, modelId }, context) => {
      ...
      const subagent = new chunkVTVCMIAI_cjs.Agent({
...
var Harness = class {
  ...
  constructor(config) {
    ...
    if (config.workspace instanceof chunkQKQGKEN7_cjs.Workspace) {
  ...
  async init() {
    ...
    if (this.config.workspace && !this.workspaceInitialized && !this.workspaceFn) {
      try {
        if (!this.workspace) {
          this.workspace = new chunkQKQGKEN7_cjs.Workspace(this.config.workspace);
        }
