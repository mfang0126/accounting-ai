...
var chunkHTAUP7ER_cjs = require('./chunk-HTAUP7ER.cjs');
...
var AISDKV6LanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      stream: chunkXNWF6CYR_cjs.createStreamFromGenerateResult(result)
    };
  }
...
function getStaticProvidersByGateway(name14) {
  return Object.fromEntries(Object.entries(chunkHTAUP7ER_cjs.PROVIDER_REGISTRY).filter(([_provider, config]) => config.gateway === name14));
}
var defaultGateways = [new chunk2P6DD7M5_cjs.NetlifyGateway(), new chunkKAVAKMOQ_cjs.ModelsDevGateway(getStaticProvidersByGateway(`models.dev`))];
var ModelRouterLanguageModel = class _ModelRouterLanguageModel {
  ...
  constructor(config, customGateways) {
    ...
    const parsed = chunkKAVAKMOQ_cjs.parseModelRouterId(normalizedConfig.id, gatewayPrefix);
  ...
  async _fetchSupportedUrls() {
    ...
    try {
      ...
      const model = await this.resolveLanguageModel({
        ...
        ...chunkKAVAKMOQ_cjs.parseModelRouterId(this.config.routerId, gatewayPrefix)
      });
  ...
  async doGenerate(options) {
    ...
    const aiSDKV5Model = new chunkXNWF6CYR_cjs.AISDKV5LanguageModel(model);
...
async function resolveModelConfig(modelConfig, requestContext = new chunkVDKWYUGC_cjs.RequestContext(), mastra) {
  ...
  if (modelConfig instanceof ModelRouterLanguageModel || modelConfig instanceof chunkXNWF6CYR_cjs.AISDKV5LanguageModel || modelConfig instanceof AISDKV6LanguageModel) {
    return modelConfig;
  }
  if (typeof modelConfig === "object" && "specificationVersion" in modelConfig) {
    if (modelConfig.specificationVersion === "v2") {
      return new chunkXNWF6CYR_cjs.AISDKV5LanguageModel(modelConfig);
    }
...
var ModelRouterEmbeddingModel = class {
  ...
  constructor(config) {
    ...
    if (normalizedConfig.url) {
      ...
      const registry = chunkHTAUP7ER_cjs.GatewayRegistry.getInstance();
...
//# sourceMappingURL=chunk-N3ROEJG4.cjs.map
//# sourceMappingURL=chunk-N3ROEJG4.cjs.map