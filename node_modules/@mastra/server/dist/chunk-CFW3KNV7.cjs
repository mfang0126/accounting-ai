...
var listLogsQuerySchema = chunkRWLJZWDL_cjs.createPagePaginationSchema().extend({
...
var listLogsResponseSchema = z__default.default.object({
  logs: z__default.default.array(chunkRWLJZWDL_cjs.baseLogMessageSchema),
...
// src/server/handlers/logs.ts
var LIST_LOG_TRANSPORTS_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  method: "GET",
...
var LIST_LOGS_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  method: "GET",
  path: "/logs",
  responseType: "json",
  ...
  handler: async ({ mastra, ...params }) => {
    try {
      ...
      chunkZKMVCV4G_cjs.validateBody({ transportId });
      const filters = chunkZKMVCV4G_cjs.parseFilters(_filters);
...
var LIST_LOGS_BY_RUN_ID_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  method: "GET",
  path: "/logs/:runId",
  responseType: "json",
  ...
  handler: async ({ mastra, runId, ...params }) => {
    try {
      const { transportId, fromDate, toDate, logLevel, filters: _filters, page, perPage } = params;
      chunkZKMVCV4G_cjs.validateBody({ runId, transportId });
      const filters = chunkZKMVCV4G_cjs.parseFilters(_filters);
...
//# sourceMappingURL=chunk-CFW3KNV7.cjs.map
//# sourceMappingURL=chunk-CFW3KNV7.cjs.map