...
var agentSkillPathParams = agentIdPathParams.extend({
  skillName: z__default.default.string().describe("Name of the skill")
});
...
var serializedAgentSchema = z__default.default.object({
  ...
  defaultOptions: chunkCXL3KPGO_cjs.defaultOptionsSchema.optional(),
  ...
  hasDraft: z__default.default.boolean().optional()
});
...
var agentExecutionBodySchema = z__default.default.object({
  ...
  messages: z__default.default.union([
    z__default.default.array(chunkRWLJZWDL_cjs.coreMessageSchema),
    // Array of messages
    z__default.default.string()
  ...
  context: z__default.default.array(chunkRWLJZWDL_cjs.coreMessageSchema).optional(),
  // Memory & Persistence
...
var modelManagementResponseSchema = chunkRWLJZWDL_cjs.messageResponseSchema;
...
//# sourceMappingURL=chunk-WAQHLUSX.cjs.map
//# sourceMappingURL=chunk-WAQHLUSX.cjs.map