...
var LIST_SCORERS_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  method: "GET",
  path: "/scores/scorers",
  responseType: "json",
...
var GET_SCORER_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  method: "GET",
...
var LIST_SCORES_BY_RUN_ID_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  method: "GET",
...
var LIST_SCORES_BY_SCORER_ID_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  method: "GET",
...
var LIST_SCORES_BY_ENTITY_ID_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  method: "GET",
  ...
  handler: async ({ mastra, entityId, entityType, ...params }) => {
    try {
      ...
      if (entityType === "AGENT") {
        const agent = await chunk5JH2BJPC_cjs.getAgentFromSystem({ mastra, agentId: entityId });
...
var SAVE_SCORE_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  method: "POST",
  path: "/scores",
  responseType: "json",
...
//# sourceMappingURL=chunk-2XI7ZVGF.cjs.map
//# sourceMappingURL=chunk-2XI7ZVGF.cjs.map