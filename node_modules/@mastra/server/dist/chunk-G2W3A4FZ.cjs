...
var listWorkflowRunsQuerySchema = chunkRWLJZWDL_cjs.createCombinedPaginationSchema().extend({
...
var workflowExecutionBodySchema = z__default.default.object({
  ...
  tracingOptions: chunkRWLJZWDL_cjs.tracingOptionsSchema.optional(),
...
var workflowControlResponseSchema = chunkRWLJZWDL_cjs.messageResponseSchema;
...
async function listWorkflowsFromSystem({ mastra, workflowId }) {
  ...
  let workflow;
  workflow = chunkHHE6BWUK_cjs.WorkflowRegistry.getWorkflow(workflowId);
  if (!workflow) {
    try {
  ...
  handler: async ({ mastra, partial }) => {
    try {
      ...
      const _workflows = Object.entries(workflows).reduce((acc, [key, workflow]) => {
        acc[key] = chunkHHE6BWUK_cjs.getWorkflowInfo(workflow, isPartial);
        return acc;
      }, {});
      return _workflows;
    } catch (error) {
      return chunkSUKFO7UM_cjs.handleError(error, "Error getting workflows");
    }
  }
});
var GET_WORKFLOW_BY_ID_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  ...
  handler: async ({ mastra, workflowId }) => {
    try {
      ...
      return chunkHHE6BWUK_cjs.getWorkflowInfo(workflow);
    } catch (error) {
...
var LIST_WORKFLOW_RUNS_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  ...
  handler: async ({
    ...
    try {
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error getting workflow runs");
    }
  }
});
...
var DELETE_WORKFLOW_RUN_BY_ID_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  ...
  handler: async ({ mastra, workflowId, runId, requestContext }) => {
    try {
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error deleting workflow run");
    }
  }
});
...
var STREAM_WORKFLOW_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  ...
  handler: async ({ mastra, workflowId, runId, resourceId, requestContext, ...params }) => {
    try {
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error streaming workflow");
    }
  }
});
...
var START_WORKFLOW_RUN_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  ...
  handler: async ({ mastra, workflowId, runId, requestContext, ...params }) => {
    try {
      ...
      return chunkSUKFO7UM_cjs.handleError(e, "Error starting workflow run");
    }
  }
});
var OBSERVE_STREAM_WORKFLOW_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  ...
  handler: async ({ mastra, workflowId, runId, requestContext }) => {
    try {
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error observing workflow stream");
    }
  }
});
...
var TIME_TRAVEL_STREAM_WORKFLOW_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  ...
  handler: async ({ mastra, workflowId, runId, requestContext, ...params }) => {
    try {
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error time traveling workflow stream");
    }
  }
});
var CANCEL_WORKFLOW_RUN_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  ...
  handler: async ({ mastra, workflowId, runId, requestContext }) => {
    try {
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error canceling workflow run");
    }
  }
});
var STREAM_LEGACY_WORKFLOW_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  ...
  handler: async ({ mastra, workflowId, runId, resourceId, requestContext, ...params }) => {
    try {
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error executing workflow");
    }
  }
});
...
//# sourceMappingURL=chunk-G2W3A4FZ.cjs.map
//# sourceMappingURL=chunk-G2W3A4FZ.cjs.map