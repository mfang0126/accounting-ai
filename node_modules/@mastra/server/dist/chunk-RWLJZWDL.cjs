...
var statusQuerySchema = z__default.default.object({
  status: z__default.default.enum(["draft", "published", "archived"]).optional().default("published").describe("Which version to resolve: published (active version) or draft (latest version)")
});
