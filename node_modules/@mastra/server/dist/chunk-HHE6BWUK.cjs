...
function getSteps(steps, path) {
  return Object.entries(steps).reduce((acc, [key, step]) => {
    ...
    acc[fullKey] = {
      ...
      inputSchema: step.inputSchema ? stringify(zodToJson.zodToJsonSchema(step.inputSchema)) : void 0,
      outputSchema: step.outputSchema ? stringify(zodToJson.zodToJsonSchema(step.outputSchema)) : void 0,
      resumeSchema: step.resumeSchema ? stringify(zodToJson.zodToJsonSchema(step.resumeSchema)) : void 0,
      suspendSchema: step.suspendSchema ? stringify(zodToJson.zodToJsonSchema(step.suspendSchema)) : void 0,
      stateSchema: step.stateSchema ? stringify(zodToJson.zodToJsonSchema(step.stateSchema)) : void 0,
  ...
  return {
    ...
    steps: Object.entries(workflow.steps).reduce((acc, [key, step]) => {
      acc[key] = {
        ...
        suspendSchema: step.suspendSchema ? stringify(zodToJson.zodToJsonSchema(step.suspendSchema)) : void 0,
        stateSchema: step.stateSchema ? stringify(zodToJson.zodToJsonSchema(step.stateSchema)) : void 0,
        requestContextSchema: step.requestContextSchema ? stringify(zodToJson.zodToJsonSchema(step.requestContextSchema)) : void 0,
        component: step.component,
        metadata: step.metadata
      };
      return acc;
    ...
    stepGraph: workflow.serializedStepGraph,
    inputSchema: workflow.inputSchema ? stringify(zodToJson.zodToJsonSchema(workflow.inputSchema)) : void 0,
    outputSchema: workflow.outputSchema ? stringify(zodToJson.zodToJsonSchema(workflow.outputSchema)) : void 0,
    stateSchema: workflow.stateSchema ? stringify(zodToJson.zodToJsonSchema(workflow.stateSchema)) : void 0,
    requestContextSchema: workflow.requestContextSchema ? stringify(zodToJson.zodToJsonSchema(workflow.requestContextSchema)) : void 0,
    options: workflow.options,
...
//# sourceMappingURL=chunk-HHE6BWUK.cjs.map
//# sourceMappingURL=chunk-HHE6BWUK.cjs.map