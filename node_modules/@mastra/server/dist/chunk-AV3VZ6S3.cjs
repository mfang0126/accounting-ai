...
var LIST_TRACES_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  method: "GET",
  path: "/observability/traces",
  responseType: "json",
  queryParamSchema: chunk4LVJBXI2_cjs.wrapSchemaForQueryParams(
  ...
  handler: async ({ mastra, ...params }) => {
    try {
      ...
      const filters = chunk4LVJBXI2_cjs.pickParams(storage.tracesFilterSchema, transformedParams);
      const pagination = chunk4LVJBXI2_cjs.pickParams(storage.paginationArgsSchema, transformedParams);
      const orderBy = chunk4LVJBXI2_cjs.pickParams(storage.tracesOrderBySchema, transformedParams);
      const observabilityStore = await getObservabilityStore(mastra);
      return await observabilityStore.listTraces({ filters, pagination, orderBy });
    } catch (error) {
      return chunkSUKFO7UM_cjs.handleError(error, "Error listing traces");
    }
  }
});
var GET_TRACE_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  method: "GET",
  ...
  handler: async ({ mastra, traceId }) => {
    try {
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error getting trace");
    }
  }
});
var SCORE_TRACES_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  method: "POST",
  ...
  handler: async ({ mastra, ...params }) => {
    try {
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error processing trace scoring");
    }
  }
});
var LIST_SCORES_BY_SPAN_ROUTE = chunk4LVJBXI2_cjs.createRoute({
  method: "GET",
  ...
  handler: async ({ mastra, ...params }) => {
    try {
      const pagination = chunk4LVJBXI2_cjs.pickParams(storage.paginationArgsSchema, params);
      const spanIds = chunk4LVJBXI2_cjs.pickParams(storage.spanIdsSchema, params);
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error getting scores by span");
    }
  }
});
...
//# sourceMappingURL=chunk-AV3VZ6S3.cjs.map
//# sourceMappingURL=chunk-AV3VZ6S3.cjs.map