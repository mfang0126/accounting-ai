...
// ../../node_modules/.pnpm/@standard-community+standard-json@0.3.5_@standard-schema+spec@1.1.0_@types+json-schema@_099a36169571a10c566d5520e1280046/node_modules/@standard-community/standard-json/dist/index-CLddUTqr.js
...
var getToJsonSchemaFn = async (vendor) => {
  ...
  switch (vendor) {
    case "arktype":
      vendorFnPromise = (await import('./arktype-aI7TBD0R-MS2OLT4Z.cjs')).default();
      break;
    case "effect":
      vendorFnPromise = (await import('./effect-QlVUlMFu-FWNF43NY.cjs')).default();
      break;
    case "sury":
      vendorFnPromise = (await import('./sury-CWZTCd75-2U3FQUNZ.cjs')).default();
      break;
    case "typebox":
      vendorFnPromise = (await import('./typebox-Dei93FPO-EBJ4ULZC.cjs')).default();
      break;
    case "valibot":
      vendorFnPromise = (await import('./valibot--1zFm7rT-KH26NMFX.cjs')).default();
      break;
    case "zod":
      vendorFnPromise = (await import('./zod-Bwrt9trS-SFESLKHY.cjs')).default();
      break;
    default:
...
//# sourceMappingURL=chunk-PF6MO6L3.cjs.map
//# sourceMappingURL=chunk-PF6MO6L3.cjs.map