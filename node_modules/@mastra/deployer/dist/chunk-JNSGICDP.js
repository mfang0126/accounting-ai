...
var getToJsonSchemaFn = async (vendor) => {
  ...
  switch (vendor) {
    case "arktype":
      vendorFnPromise = (await import('./arktype-aI7TBD0R-MD6ESOAI.js')).default();
      break;
    case "effect":
      vendorFnPromise = (await import('./effect-QlVUlMFu-UDX7FFQO.js')).default();
      break;
    case "sury":
      vendorFnPromise = (await import('./sury-CWZTCd75-52HHC6OD.js')).default();
      break;
    case "typebox":
      vendorFnPromise = (await import('./typebox-Dei93FPO-TURR2FV5.js')).default();
      break;
    case "valibot":
      vendorFnPromise = (await import('./valibot--1zFm7rT-O4VBDBTD.js')).default();
      break;
    case "zod":
      vendorFnPromise = (await import('./zod-Bwrt9trS-UDJPKIQS.js')).default();
      break;
    default:
...
//# sourceMappingURL=chunk-JNSGICDP.js.map
//# sourceMappingURL=chunk-JNSGICDP.js.map